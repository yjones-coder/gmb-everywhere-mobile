import { StyleSheet, ScrollView, ActivityIndicator, View, TouchableOpacity, TextInput, Alert } from 'react-native';
                    ...
                    <View style={styles.teleportContainer}>
                        ...
                        <View style={styles.teleportHero}>
                            ...
                            <ThemedText style={styles.teleportDescription}>
                                Select a location to see how your business ranks from that area.
                            </ThemedText>
                        </View>

                        {/* Web Map Placeholder */}
                        <View style={[styles.webMapPlaceholder, { backgroundColor: colors.surface, borderColor: colors.border }]}>
                            <IconSymbol name="map.fill" size={64} color={colors.tabIconDefault} />
                            <ThemedText type="defaultSemiBold" style={styles.webMapTitle}>Map Not Available on Web</ThemedText>
                            <ThemedText style={styles.webMapText}>
                                Interactive maps are only available on iOS and Android devices. Please use the manual coordinate input below to teleport to a location.
                            </ThemedText>
                        </View>
                        ...
                        {heatmapLoading ? (
                            ...
                            <>
                                ...
                                <View style={[styles.webMapPlaceholder, { backgroundColor: colors.surface, borderColor: colors.border }]}>
                                    ...
                                    <ThemedText type="defaultSemiBold" style={styles.webMapTitle}>Map Not Available on Web</ThemedText>
                                    <ThemedText style={styles.webMapText}>
                                        Interactive maps are only available on iOS and Android devices. The heatmap data is displayed in the statistics above.
                                    </ThemedText>
                                </View>
